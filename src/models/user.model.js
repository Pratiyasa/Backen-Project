...
userSchema.pre("save",async function(next){       //for encrption of password
...
userSchema.methods.isPasswordCorrect = async function(password){   //to check the encrypted password 
